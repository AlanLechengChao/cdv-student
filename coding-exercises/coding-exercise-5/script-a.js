...
function gotData(incomingData){
  ...
  function drawViz(){
    ...
    function assignYearKeys(d,i){
      return d.Country;
    };
    let datagroups = vizGroup.selectAll(".datagroup").data(currentYearData, assignYearKeys);
    ...
    enteringElements.append('text')
      ...
      .on('mouseout', function (d, i) {
        d3.select(this).transition().duration(0).style("opacity", 0.05);
       })
    ;
